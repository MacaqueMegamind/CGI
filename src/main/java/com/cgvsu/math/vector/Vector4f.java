...
public class Vector4f implements Vector<Vector4f> {
     ...
     * @param v The vector.
     */
    public Vector4f(com.cgvsu.math.vector.Vector2f v) {
        this.x = v.x;
        this.y = v.y;
        this.z = 0.0f;
        this.w = 0.0f;
     ...
     * @param w The w component of the vector.
     */
    public Vector4f(com.cgvsu.math.vector.Vector2f v, float z, float w) {
        this.x = v.x;
        this.y = v.y;
        this.z = z;
        this.w = w;
     ...
     * @return This vector for chaining.
     */
    public Vector4f set(com.cgvsu.math.vector.Vector2f v) {
        this.x = v.x;
        this.y = v.y;
        this.z = 0.0f;
        this.w = 0.0f;
