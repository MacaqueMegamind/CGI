...
public class Vector3f implements Vector<Vector3f> {
     ...
     * @param v The vector.
     */
    public Vector3f(com.cgvsu.math.vector.Vector2f v) {
        this.x = v.x;
        this.y = v.y;
        this.z = 0.0f;
    }
     ...
     * @param z The z component of the vector.
     */
    public Vector3f(com.cgvsu.math.vector.Vector2f v, float z) {
        this.x = v.x;
        this.y = v.y;
        this.z = z;
    }
     ...
     * @return This vector for chaining.
     */
    public Vector3f set(com.cgvsu.math.vector.Vector2f v) {
        this.x = v.x;
        this.y = v.y;
        this.z = 0.0f;
        return this;
